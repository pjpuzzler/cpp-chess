    ...
    public:
        ...
        SquareSet pin(Color color, Square square) const {
            ...
            int main() {
                ...
                std::cout << board.is_pinned(chess::WHITE, chess::C3) << std::endl << std::endl;
            ...
            */
            ...
            struct transposition_hash {
                size_t operator()(const tuple<Bitboard, Bitboard, Bitboard, Bitboard, Bitboard, Bitboard, Bitboard, Bitboard, Color, Bitboard, optional<Square>> &key) const {
                    return hash<Bitboard>()(get<0>(key)) ^ hash<Bitboard>()(get<1>(key)) ^ hash<Bitboard>()(get<2>(key)) ^ hash<Bitboard>()(get<3>(key)) ^ hash<Bitboard>()(get<4>(key)) ^ hash<Bitboard>()(get<5>(key)) ^ hash<Bitboard>()(get<6>(key)) ^ hash<Bitboard>()(get<7>(key)) ^ hash<Color>()(get<8>(key)) ^ hash<Bitboard>()(get<9>(key)) ^ (get<10>(key) ? hash<Square>()(*get<10>(key)) : hash<uint8_t>()(64));
                }
            };
